...
//CHECK:   %mem_St_ptr = getelementptr %"t_struct(St)64", %"t_struct(St)64"* %St_casted_ptr, i32 0, i32 1, i32 0
//CHECK:   %mem_load = load i256, i256* %mem_St_ptr, align 4
...
//CHECK:   %St_casted_ptr = inttoptr i256 %"zero_value_for_split_t_struct$_St_$10_memory_ptr" to %"t_struct(St)10_storage"*
//CHECK:   %mem_St_ptr = getelementptr %"t_struct(St)10_storage", %"t_struct(St)10_storage"* %St_casted_ptr, i32 0, i32 1, i32 0
//CHECK:   store i256 1, i256* %mem_St_ptr, align 4
//CHECK:   ret void
//CHECK: }