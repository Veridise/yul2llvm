...
class YulTranslator:
    def __init__(self, *args, **kwargs):
        ...
        self.translation_sequence = [
            "remove_data_metadata",
            "rewrite_constructor_arguments",
            "remove_post_constructor_datacall",
            "hijack_dispatcher_revert",
            "hijack_dispatcher_miss",
        ]
    ...
    def _t_hijack_eurus_prank_once(self, yul_str):
        ...
        new_str = pattern0.sub(
            r"\1"
            + "function fun_eurus_prank_once_"
            + r"\2"
            + "("
            + r"\3"
            + ") {\n"
    ...
    def _t_hijack_rosette_assume(self, yul_str):
        ...
        new_str = pattern0.sub(
            ...
            + "\n"
            + r"\6"
            + "// adapted by Eurus: hijack_rosette_assume\n"
            + r"\6"
            + "rosette_assume("
            + r"\7"
            + ", sub("
    ...
    def _t_hijack_rosette_assert(self, yul_str):
        ...
        new_str = pattern0.sub(
            ...
            + "\n"
            + r"\6"
            + "// adapted by Eurus: hijack_rosette_assert\n"
            + r"\6"
            + "rosette_assert("
            + r"\7"
            + ", sub("
    ...
    def _t_hijack_rosette_cex(self, yul_str):
        ...
        new_str = pattern0.sub(
            ...
            + "\n"
            + r"\6"
            + "// adapted by Eurus: hijack_rosette_cex\n"
            + r"\6"
            + "rosette_cex("
            + r"\7"
            + ", sub("
    ...
    def _t_hijack_eurus_symbolic_uintX(self, yul_str):
        ...
        new_str = pattern0.sub(
            r"\1"
            + "function fun_eurus_symbolic_uint"
            + r"\2"
            + "_"
            + r"\3"
            + "("
    ...
    def _t_hijack_eurus_symbolic_intX(self, yul_str):
        ...
        new_str = pattern0.sub(
            r"\1"
            + "function fun_eurus_symbolic_int"
            + r"\2"
            + "_"
            + r"\3"
            + "("
            ...
            + "\n"
            + r"\7"
            + "// adapted by Eurus: hijack_eurus_symbolic_intX\n"
            + r"\7"
            + r"\5"
            " := eurus_symbolic_uint256("
            + r"\8"
    ...
    def _t_hijack_eurus_symbolic_address(self, yul_str):
        ...
        new_str = pattern0.sub(
            r"\1"
            + "function fun_eurus_symbolic_address_"
            + r"\2"
            + "("
            + r"\3"
            + ") -> "
            ...
            + "\n"
            + r"\6"
            + "// adapted by Eurus: hijack_eurus_symbolic_address\n"
            + r"\6"
            + r"\4"
            + " := eurus_symbolic_address("
            + r"\7"
            + ", sub("
            + r"\8"
            + ", "
    ...
    def _t_hijack_eurus_symbolic_bool(self, yul_str):
        ...
        new_str = pattern0.sub(
            r"\1"
            + "function fun_eurus_symbolic_bool_"
            + r"\2"
            + "("
            + r"\3"
            + ") -> "
    ...
    def _t_rewrite_constructor_arguments(self, yul_str):
        pattern0 = re.compile(
            r"let programSize := datasize\(\"(.*)\"\)"
            + r"([ \n]*)"
            + r"let argSize := sub\(codesize\(\), programSize\)"
            + r"([ \n]*)"
            + r"let memoryDataOffset := allocate_memory\(argSize\)"
            + r"([ \n]*)"
            + r"codecopy\(memoryDataOffset, programSize, argSize\)"
            + r"([ \n]*)",
            re.MULTILINE,
        )
        new_str = pattern0.sub(
    ...
    def _t_remove_post_constructor_datacall(self, yul_str):
        pattern0 = re.compile(
            r"let (.*) := allocate_unbounded\(\)"
            + r"([ \n]*)"
            + r"codecopy\((.*), dataoffset\(\"(.*)\"\), datasize\(\"(.*)\"\)\)"
            + r"([ \n]*)"
            + r"return\((.*), datasize\(\"(.*)\"\)\)"
            + r"([ \n]*)",
            re.MULTILINE,
