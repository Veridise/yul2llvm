...
class YulPrintListener(YulListener):
    ...
    def enterYul_typed_identifier_list(
        self, ctx: YulParser.Yul_typed_identifier_listContext
    ):
    ...
    def exitYul_typed_identifier_list(
        self, ctx: YulParser.Yul_typed_identifier_listContext
    ):
        self.built_string += "]},"
    ...
    def enterYul_true_literal(self, ctx: YulParser.Yul_true_literalContext):
        self.built_string += '{{"type":"yul_true_literal","children":["{}"]}},'.format(
            ctx.TRUE_LITERAL()
        )
    ...
    def enterYul_false_literal(self, ctx: YulParser.Yul_false_literalContext):
        self.built_string += '{{"type":"yul_false_literal","children":["{}"]}},'.format(
            ctx.FALSE_LITERAL()
        )
    ...
    def enterYul_hex_number(self, ctx: YulParser.Yul_hex_numberContext):
        self.built_string += '{{"type":"yul_hex_number","children":["{}"]}},'.format(
            ctx.HEX_NUMBER()
        )
    ...
    def enterYul_dec_number(self, ctx: YulParser.Yul_dec_numberContext):
        self.built_string += '{{"type":"yul_dec_number","children":["{}"]}},'.format(
            ctx.DEC_NUMBER()
        )
    ...
    def enterYul_type_name(self, ctx: YulParser.Yul_type_nameContext):
        self.built_string += '{{"type":"yul_type_name","children":["{}"]}},'.format(
            ctx.ID_LITERAL()
        )
    ...
    def enterYul_identifier(self, ctx: YulParser.Yul_identifierContext):
        self.built_string += '{{"type":"yul_identifier","children":["{}"]}},'.format(
            ctx.ID_LITERAL()
        )
    ...
    def enterYul_string_literal(self, ctx: YulParser.Yul_string_literalContext):
        ...
        self.built_string += '{{"type":"yul_string_literal","children":[{}]}},'.format(
            ctx.STRING_LITERAL()
        )
