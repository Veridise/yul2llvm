...
def parse_args():
    ...
    translators = ['yul2llvm_cpp', 'yul2ksir']
    ...
    parser.add_argument('-t', '--translator', choices=list(translators), default=args_default['translator'], 
                            help = "Name of the binary used for tranlation")
    ...
    for fname, contracts in solc_output.contracts.items():
        for name, contract in contracts.items():
            ...
            if the_contract.yul_ast != {}:
                ...
                translate_yul(
                    the_contract, args.disable_module_verification, logger, args.translator
                )
